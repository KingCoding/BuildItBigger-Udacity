...
import com.udacity.gradle.builditbiger.MainActivityPaid;
 ...
 */
public class EndPointsAsyncTaskPaid extends AsyncTask<Pair<Context, String>, Void, String> {
    ...
    public EndPointsAsyncTaskPaid(boolean execMode){
        lock = new Object();
    ...
    protected void onPostExecute(String joke) {
        ...
        if(executionModeNotTest)
            ((MainActivityPaid)context).displayJoke(joke);
    }
